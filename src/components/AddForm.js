...
import { addSmurf, fetchFail } from "../actions/index";
...
const AddForm = (props) =>
{
    ...
    const handleSubmit = e =>
    {
        ...
        {
            props.fetchFail("All fields must be filled in.");
        }
        else
        {
            const newSmurf =
...
export default connect(mapStateToProps, { fetchFail, addSmurf })(AddForm);
